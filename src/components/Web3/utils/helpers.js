...
import contract_data from "../data/contract/contract.json";
import token_data from "../data/usdt/token.json";
...
export const TARGET_CHAIN = toHex(contract_data.TARGET_CHAIN);
export const DECIMALS = token_data.USDT_DECIMALS;
